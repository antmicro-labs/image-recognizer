...
for file1, file2 in zip(files1, files2):
    # Open the files
    print(i)
    with open(os.path.join(GOOD_DIRECTORY, file1), 'r') as f1:
        with open(os.path.join(BAD_DIRECTORY, file2), 'r') as f2:
            print(i)
            ...
            bad_tensor = tf.io.decode_image(image_string_bad, channels=1, dtype=tf.uint8)
