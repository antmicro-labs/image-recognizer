...
class ColorFormat:
    ...
    def bits_per_components(self, bpcs):
        ...
        raise ValueError("Provided value should be an iterable of 3 or 4 values!")
...
class SubsampledColorFormat(ColorFormat):
    ...
    def __init__(
        ...
        super().__init__(
            pixel_format, endianness, pixel_plane, bpc1, bpc2, bpc3, bpc4, name
        )
...
AVAILABLE_FORMATS = {
    ...
    "GRAY": ColorFormat(
        PixelFormat.MONO, Endianness.BIG_ENDIAN, PixelPlane.PACKED, 8, 0, 0, name="GRAY"
    ),
    "GRAY10": ColorFormat(
        PixelFormat.MONO,
        Endianness.BIG_ENDIAN,
